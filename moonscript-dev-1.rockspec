...
build = {
	...
	modules = {
		...
		["moonscript.parse.errors"] = "moonscript/parse/errors.lua",
		["moonscript.parse.grammar"] = "moonscript/parse/grammar.lua",
		["moonscript.parse.native"] = { sources = {"moonscript/parse/native.c"} },
		["moonscript.parse.slow"] = "moonscript/parse/slow.lua",
		["moonscript.parse.tree"] = "moonscript/parse/tree.lua",
